...
$app->rota(SOLICITACOES . 'adicionar', 'POST', [SolicitacoesControlador::class, 'adcionarSolicitacao']);
$app->rota(SOLICITACOES . 'adicionar', 'OPTIONS', [SolicitacoesControlador::class, 'adcionarSolicitacao']);
